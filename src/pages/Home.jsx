...
const Home = () => {
  const schema = {
    ...
    name: "Lumoshive Blog",
    description:
      "LumosBlog is a blog website where you can find all the latest news and updates about the latest technologies.",
    image:
      "https://lumos-project-8.vercel.app/android/android-launchericon-512-512.png",
  };
  return (
    <>
      <MyHelmet
